...
const WifiMarauderItem items[NUM_MENU_ITEMS] = {
    ...
    {"SSID",
     ...
     NO_TIP},
    {"List",
     {"ap", "ssid", "station", "findmy", "IPs", "probes", "bluetooth"},
     7,
    ...
    {"Port Scan",
     ...
     SHOW_STOPSCAN_TIP},
    {"Sniff",
     {"beacon", "deauth", "pmkid", "probe", "pwn", "raw", "bt", "skim", "findmy", "flipper", "flock", "meta", "mactrack", "packetcount", "pineapple", "multissid", "sae"},
     17,
     {"sniffbeacon",
      "sniffdeauth",
      "sniffpmkid",
